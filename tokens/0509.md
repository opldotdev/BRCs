# BRC-509: BSV-21 Fungible Tokens (JSON / Legacy)
...
| 1Sat origin and sat ordering | [BRC-506](./0506.md) |
| Inscription envelopes | [BRC-507: Inscriptions](./0507.md) |
...
Inscription envelope rules are defined in [BRC-507: Inscriptions](./0507.md). Unrecognized JSON keys MUST be ignored; only fields defined here affect validity.

### Relationship to 1Sat Ordinals

The `ord` envelope is only the **carrier** for the BSV-21 JSON payload. Token identity, transfers, mints, and burns follow the UTXO balance and authority rules in this document — **not** [BRC-506](./0506.md) sat ordering or origin tracking.
...
1. **Inscription** — a 1Sat / `ord` inscription whose body is image (or other display) content ([BRC-507](./0507.md)); or
2. **B protocol** — a B ([BRC-501](../scripts/0501.md), Bitcom `19HxigV4QyBv3tHpQVcUEQyq1pzZVdoAut`) file output whose payload is the image bytes.
...
5. [BRC-506](./0506.md) — 1Sat core
6. [BRC-507: Inscription envelopes](./0507.md)
7. [BRC-501: B — Bitcoin Data Protocol](../scripts/0501.md)
