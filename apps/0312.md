...
**Contributors:** Austin Rappaport (MrZ) — co-maintainer of Bitcoin Schema; the Bitcoin Schema community; Kurt Wuckert Jr. (kurt@opl.dev), David Case (dcase@opl.dev), Michael Boyd (root@opl.dev), Dan Wagner (dan@opl.dev) — implementation, infrastructure, and proliferation.
