...
**Informative note:** the Bitcom documentation ([BRC-310](./0310.md) §6) states that `bit://19HxigV4QyBv3tHpQVcUEQyq1pzZVdoAut/<txid>` is equivalent to `b://<txid>` — both point to the same content — and recommended the `bit://` form for new references. That equivalence is a claim of the Bitcom documentation, not of B itself.
